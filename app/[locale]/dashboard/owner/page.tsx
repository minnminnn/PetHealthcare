...
export default async function OwnerDashboardPage({
  ...
  if (!session?.user) {
    return i18nRedirect({ href: "/login", locale: locale as Locale });
  }
          ...
          <div className="space-y-5">
            ...
            <div className="card-base p-5">
              ...
              <div className="space-y-2.5">
                {[
                  {
                    label: "Nhỏ gáy phòng ve bọ chét",
                    date: "14/10/2025",
                    urgent: false,
                  },
                  {
                    label: "Tẩy giun định kỳ",
                    date: "14/12/2025",
                    urgent: false,
                  },
                  {
                    label: "Nhắc tiêm FVRCP hàng năm",
                    date: "20/04/2026",
                    urgent: false,
                  },
                ].map((r, i) => (
